...
var routes = [
    {
        ...
        canActivate: [__WEBPACK_IMPORTED_MODULE_11__shared__["a" /* AuthGuard */]],
        children: [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__component_map_map_component__ = __webpack_require__("../../../../../src/app/component/map/map.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__component_projects___ = __webpack_require__("../../../../../src/app/component/projects/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__component_employee_employee_component__ = __webpack_require__("../../../../../src/app/component/employee/employee.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__component_report_report_component__ = __webpack_require__("../../../../../src/app/component/report/report.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__component_alert_alert_component__ = __webpack_require__("../../../../../src/app/component/alert/alert.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__component_settings_settings_component__ = __webpack_require__("../../../../../src/app/component/settings/settings.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__shared_sidenav_sidenav_component__ = __webpack_require__("../../../../../src/app/shared/sidenav/sidenav.component.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_11__component_map_map_component__["a" /* MapComponent */],
                __WEBPACK_IMPORTED_MODULE_12__component_projects___["a" /* ProjectsComponent */],
                __WEBPACK_IMPORTED_MODULE_13__component_employee_employee_component__["a" /* EmployeeComponent */],
                __WEBPACK_IMPORTED_MODULE_14__component_report_report_component__["a" /* ReportComponent */],
                __WEBPACK_IMPORTED_MODULE_15__component_alert_alert_component__["a" /* AlertComponent */],
                __WEBPACK_IMPORTED_MODULE_16__component_settings_settings_component__["a" /* SettingsComponent */],
                __WEBPACK_IMPORTED_MODULE_17__shared_sidenav_sidenav_component__["a" /* SidenavComponent */],
                ...
                __WEBPACK_IMPORTED_MODULE_12__component_projects___["b" /* ViewProjectComponent */],
...
var OnDutyChartComponent = (function () {
    ...
    OnDutyChartComponent.prototype.updateChart = function () {
        ...
        if (this.dutyChart !== null && (typeof this.dutyChart !== 'undefined')) {
            ...
            for (var ptr in this.dutyChart) {
                ...
                chartArray.push({
                    'name': data.pname,
                    'series': [
                        { "name": "ok", "value": parseInt(data.ok) },
                        { "name": "unhealthy", "value": parseInt(data.unhealthy) },
                        { "name": "not on duty", "value": parseInt(data.workernum) - parseInt(data.onduty) }
                    ]
                });
            }
            // console.log(chartArray);
            this.chartData = new BarChart(chartArray);
        }
    };
...
var AddEmployeeComponent = (function () {
    ...
    AddEmployeeComponent.prototype.onSubmit = function (value) {
        var _this = this;
        value['w_id'] = this.newid;
        console.log(value);
        this.callApi.postWithFile(__WEBPACK_IMPORTED_MODULE_2__shared_services__["a" /* ApiCmd */].newEmployee, value, this.photo)
            .subscribe(function (response) {
    ...
    ], AddEmployeeComponent.prototype, "newid", void 0);
    __decorate([
...
var EmployeeComponent = (function () {
    function EmployeeComponent(CallApi, reloadService, http) {
        ...
        this.http = http;
        this.defaultNull = "-";
        // [{"_id":"w1","_rev":"4-2ab2563cd08a90e95c6f9a7532c25b52","type":"worker","w_id":"0001","w_name":"Adam Smith","w_age":"30","w_photo":"null","w_email":"ccc@gmail.com","w_bloodtype":"A","w_height":"172","w_weight":"73","goggles_on":"true","goggles_id":"11111","helmet_on":"true","helmet_id":"11111","vest_on":"false","vest_id":"11111","boots_on":"true","boots_id":"11111","w_p_id":"PJ002","w_on_duty":"true"},{"_id":"w2","_rev":"5-80135927f60ef52f67d61287f49e6924","type":"worker","w_id":"0002","w_name":"Lee Yi","w_age":"44","w_photo":"null","w_email":"ccc@gmail.com","w_bloodtype":"O","w_height":"175","w_weight":"80","goggles_on":"false","goggles_id":"22222","helmet_on":"false","helmet_id":"22222","vest_on":"false","vest_id":"22222","boots_on":"true","boots_id":"22222","w_p_id":"PJ002","w_on_duty":"true"},{"_id":"w5","_rev":"6-84c05e7b127cfcfe748bb03b784d3ea9","type":"worker","w_id":"0005","w_name":"John Steve","w_age":"28","w_photo":"null","w_email":"hhh@gmail.com","w_bloodtype":"B","w_height":"175","w_weight":"75","goggles_on":"true","goggles_id":"55555","helmet_on":"true","helmet_id":"55555","vest_on":"true","vest_id":"55555","boots_on":"true","boots_id":"55555","w_p_id":"PJ001","w_on_duty":"true"},{"_id":"w6","_rev":"2-8996a402daa40ba5ef1655f21157ad33","type":"worker","w_id":"0006","w_name":"Karl Marx","w_age":"38","w_photo":"null","w_email":"ggg@gmail.com","w_bloodtype":"AB","w_height":"178","w_weight":"85","goggles_on":"true","goggles_id":"66666","helmet_on":"false","helmet_id":"66666","vest_on":"false","vest_id":"66666","boots_on":"true","boots_id":"66666","w_p_id":"null","w_on_duty":"false"},{"_id":"w4","_rev":"6-11349936c9c540585df2b151a7ebe8da","type":"worker","w_id":"0004","w_name":"Hegel","w_age":"22","w_photo":"null","w_email":"123@gmail.com","w_bloodtype":"B","w_height":"170","w_weight":"66","goggles_on":"true","goggles_id":"44444","helmet_on":"false","helmet_id":"44444","vest_on":"false","vest_id":"44444","boots_on":"true","boots_id":"44444","w_p_id":"PJ003","w_on_duty":"true"},{"_id":"w3","_rev":"6-c27ca179298f0f5cb07ec6aba32a52e7","type":"worker","w_id":"0003","w_name":"Abu Abim","w_age":"24","w_photo":"null","w_email":"abc@gmail.com","w_bloodtype":"O","w_height":"172","w_weight":"80","goggles_on":"true","goggles_id":"33333","helmet_on":"true","helmet_id":"33333","vest_on":"true","vest_id":"33333","boots_on":"true","boots_id":"33333","w_p_id":"PJ001","w_on_duty":"true"}];
    ...
    EmployeeComponent.prototype.getList = function (url) {
        ...
        this.CallApi.getData(url)
            ...
            if (_this.employees.length > 0) {
                _this.w_id = _this.employees[_this.employees.length - 1]['w_id'];
                _this.w_id = "W" + (parseInt(_this.w_id.substr(1)) + 1);
            }
            else {
                _this.w_id = "W1";
            }
    ...
    EmployeeComponent.prototype.closeAlert = function () {
...
var SendCommandComponent = (function () {
    ...
    SendCommandComponent.prototype.sendCommand = function (event) {
        ...
        if (event == "heartrate") {
            alert("Heart rate reading command have been sent");
        }
        else if (event == "shutdown") {
            alert("Shut down command have been sent");
        }
...
var SensorDataComponent = (function () {
    ...
    SensorDataComponent.prototype.updateCard = function () {
        ...
        if (this.sensorData !== null && typeof this.sensorData !== 'undefined') {
            ...
            var data = [
                { 'name': 'Heart Rate', 'value': hr + ' bpm' },
                { 'name': 'Number of Steps', 'value': steps },
                { 'name': 'Total Number of Steps', 'value': steps_total },
                { 'name': 'Battery Level', 'value': battery + '%' }
            ];
...
var ViewEmployeeComponent = (function () {
    function ViewEmployeeComponent(_route, callApi, fb, location, http) {
        ...
        this.http = http;
        //project this user currently working
        this.project = [];
        this.rowsOnPage = 5;
        this.sortBy = "w_id";
        this.sortOrder = "asc";
    ...
    ViewEmployeeComponent.prototype.getWorkerDetail = function (url) {
        ...
        this.callApi.getData(url)
            ...
            if (JSON.stringify(_this.profile.project).length > 2) {
                _this.project = [];
                _this.project.push(_this.profile.project);
            }
            ;
    ...
    ViewEmployeeComponent.prototype.initData = function (profile) {
        this.userForm = this.fb.group({
            ...
            emailAddress: [profile.w_name_photo.w_name],
            contact: [profile.w_info.w_contact],
            position: [profile.w_info.w_position],
            deviceID: [profile.dev_id],
        });
    };
    ViewEmployeeComponent.prototype.onSubmit = function (value) {
        var _this = this;
...
var MapComponent = (function () {
    ...
    MapComponent.prototype.newPopup = function (newPopupDetails, id, name, status, photo, location, type, description) {
        var popup = newPopupDetails("ID", id) +
            newPopupDetails("Name", name) +
            newPopupDetails("Status", status) +
            newPopupDetails("Location", location) +
            newPopupDetails("Description", description);
        if (photo != null) {
    ...
    MapComponent.prototype.setWorker = function (project) {
        ...
        for (var wpointer in project.worker) {
            ...
            var workerMarker = this.newCircleMarker(worker_latlng, null, this.newPopup(this.newPopupDetails, worker.w_id, worker.w_name_photo.w_name, worker.w_status.health_status, worker.w_name_photo.w_photo, null, "employee", null));
            ...
            if (worker.w_latlng_valid === 'V' && (worker.w_dev_data.zone === 'Not in zone' || worker.w_dev_data.zone === '' || !('zone' in worker.w_dev_data))) {
                workerLocMarker = this.newCircleMarker(worker_latlng, null, null);
...
var AddProjectComponent = (function () {
    ...
    AddProjectComponent.prototype.ngOnInit = function () {
        this.projectForm = this.fb.group({
            projectId: ['', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required]],
            ...
            projectStartDate: ['', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required]],
            projectLocation: ['', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required]],
            projectLatLng: [''],
            projectSize: [''],
            projectStories: [''],
...
var ProjectDetailComponent = (function () {
    function ProjectDetailComponent(callApi) {
        ...
        this.items = [];
        //datepicker config
        this.bsConfig = { containerClass: "theme-default", /*locale: "en-gb",*/ showWeekNumbers: false, dateInputFormat: 'DD MM YYYY' };
        this.bsValue = null;
...
var ProjectWorkersComponent = (function () {
    function ProjectWorkersComponent(callApi) {
        ...
        this.getNoProjectWorker(__WEBPACK_IMPORTED_MODULE_2__shared_services__["a" /* ApiCmd */].noProjectWorker);
    }
    ...
    ProjectWorkersComponent.prototype.getNoProjectWorker = function (url) {
        var _this = this;
        this.callApi.getData(url)
            .subscribe(function (data) {
            _this.employees = data;
...
var ProjectsTableComponent = (function () {
    ...
    //function to close the notification alert
    ProjectsTableComponent.prototype.closeAlert = function () {
        this.formSubmitted = false;
    };
    __decorate([
...
var HealthVisualComponent = (function () {
    ...
    HealthVisualComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.callApi.getData(__WEBPACK_IMPORTED_MODULE_1__shared_services__["a" /* ApiCmd */].reportSummary + this.display).subscribe(function (data) { _this.summaryReport = data; });
        this.intervalHook = setInterval(function () {
...
var ReportCurrentComponent = (function () {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Array)
    ], ReportCurrentComponent.prototype, "data", void 0);
...
var SettingsComponent = (function () {
    ...
    //function to close the notification alert
    SettingsComponent.prototype.closeAlert = function () {
        this.formSubmitted = false;
    };
...
module.exports = "<div class=\"alert alert-success alert-dismissable\" *ngIf=\"showFeedback\">\r\n  <button type=\"button\" class=\"close\" data-dismiss=\"alert\" (click)=\"closeAlert()\">&times;</button>\r\n  <strong>{{indicationMessage|translate}}!</strong>{{bodyMessage|translate}}\r\n</div>"
...
var FeedbackComponent = (function () {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Object)
    ], FeedbackComponent.prototype, "indicationMessage", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Object)
    ], FeedbackComponent.prototype, "bodyMessage", void 0);
...
var HeaderComponent = (function () {
    function HeaderComponent(router, activatedRoute, authService, tabService) {
        var _this = this;
        this.router = router;
...
var ApiCmd = (function () {
    ...
    ApiCmd.noProjectWorker = apiDom + "list/worker_free";
    //POST
