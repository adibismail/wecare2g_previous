...
var AppComponent = (function () {
    ...
    AppComponent.prototype.changeMapScript = function (lang) {
        ...
        if (lang == "en")
            ...
            s.src = "https://www.google.cn/maps/api/js?v=3&libraries=places&region=cn&language=zh-CN&key=AIzaSyAeg8uvtlLzc1zwyNL1z_UXZwZzjBw0B2g";
        else
...
var MessagingService = (function () {
    ...
    MessagingService.prototype.updateToken = function (token) {
        ...
        this.callApi.postData(__WEBPACK_IMPORTED_MODULE_6__call_apis_api_cmd__["a" /* ApiCmd */].updatePushToken, JSON.stringify(data))
            .subscribe((function (response) {
