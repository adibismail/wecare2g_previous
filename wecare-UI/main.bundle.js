...
var EmployeeHistoryMapComponent = (function () {
    function EmployeeHistoryMapComponent(_route, callApi, datePipe, _bsDatepickerConfig) {
        ...
        this.options = {
            ...
            layers: [__WEBPACK_IMPORTED_MODULE_4_leaflet__["tileLayer"]('http://www.google.com/maps/vt?lyrs=m@189&x={x}&y={y}&z={z}')],
            zoom: 8,
...
var MapComponent = (function () {
    ...
    function MapComponent(callApi, _route, fb, translate) {
        ...
        this.map_GoogleENNormalMap = __WEBPACK_IMPORTED_MODULE_5_leaflet__["tileLayer"]('http://www.google.com/maps/vt?lyrs=m@189&x={x}&y={y}&z={z}', { maxZoom: 18 });
        this.map_GoogleENSatelliteMap = __WEBPACK_IMPORTED_MODULE_5_leaflet__["tileLayer"]('http://www.google.com/maps/vt?lyrs=s,h@189&x={x}&y={y}&z={z}', { maxZoom: 18 });
        ...
        this.layersControl = {
            baseLayers: {
                'Google Normal': this.map_GoogleENNormalMap,
                'Google Satelite': this.map_GoogleENSatelliteMap,
                'Google CN Normal': this.map_GoogleCNNormalMap,
                'Google CN Satelite': this.map_GoogleCNSatelliteMap,
...
var RouterComponent = (function () {
    function RouterComponent(CallApi, reloadService, http) {
        ...
        this.map_GoogleENNormalMap = __WEBPACK_IMPORTED_MODULE_3_leaflet__["tileLayer"]('http://www.google.com/maps/vt?lyrs=m@189&x={x}&y={y}&z={z}', { maxZoom: 18 });
        this.map_OpenStreetMap = __WEBPACK_IMPORTED_MODULE_3_leaflet__["tileLayer"]('http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', { maxZoom: 18 });
        this.map_TianDiTuNormal = __WEBPACK_IMPORTED_MODULE_3_leaflet__["layerGroup"]([
            __WEBPACK_IMPORTED_MODULE_3_leaflet__["tileLayer"]('http://t{s}.tianditu.cn/DataServer?T=vec_w&X={x}&Y={y}&L={z}', { maxZoom: 18, subdomains: ['0', '1', '2', '3', '4', '5', '6', '7'] }),
            __WEBPACK_IMPORTED_MODULE_3_leaflet__["tileLayer"]('http://t{s}.tianditu.cn/DataServer?T=cva_w&X={x}&Y={y}&L={z}', { maxZoom: 18, subdomains: ['0', '1', '2', '3', '4', '5', '6', '7'] })
